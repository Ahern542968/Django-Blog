...
class LikeQuerySet(models.query.QuerySet):
    ...
    def get_like_num(self, content_type, object_id):
...
class Like(models.Model):
    ...
    user = models.ForeignKey(settings.AUTH_USER_MODEL, related_name='liker', on_delete=models.CASCADE, verbose_name='用户')
